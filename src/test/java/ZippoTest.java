...
public class ZippoTest {
    ...
    public void checkCountryInResponseBody() {
        ...
        // bodynin country değişkeni "United States" e eşitmi?
...
//    https://jsonpathfinder.com/
    ...
    public void checkHasItemy() {
        ...
        given()
                ...
                //.log().body()
                .statusCode(200)
                .body("places.'place name'", hasItem("Dörtağaç Köyü")) // bütün place namelerde dörtağaç köyü varmı?
    ...
    public void queryParamTest() {
        given()
                ...
                .when()
                .get("https://gorest.co.in/public/v1/users?page=2")// ?page=1
    ...
    @Test
    public void extractingJsonPathResponAll(){
